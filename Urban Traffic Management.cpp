...
void build_user() {
	FILE *fp;
	// 普通用户
	fp = fopen("/Users/gongzhaorui/Desktop/trafic_information/normal_user.txt", "r");
	if (fp != NULL) {
		while (!feof(fp)) {
	...
	// 管理员用户
	fp = fopen("/Users/gongzhaorui/Desktop/trafic_information/manager_user.txt", "r");
	if (fp != NULL) {
		while (!feof(fp)) {
...
//    test_output();
	...
	/****************用户信息***************/
	// 普通用户
	fp = fopen("/Users/gongzhaorui/Desktop/trafic_information/normal_user.txt", "w+");
	if (fp != NULL) {
		for (int i = 0; i < num_of_npeople; i++) {
	...
	fclose(fp);
	// 管理员用户
	fp = fopen("/Users/gongzhaorui/Desktop/trafic_information/manager_user.txt", "w+");
	if (fp != NULL) {
		for (int i = 0; i < num_of_mpeople; i++) {
